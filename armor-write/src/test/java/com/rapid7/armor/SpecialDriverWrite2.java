...
public class SpecialDriverWrite2 {
  private static final Logger LOGGER = LoggerFactory.getLogger(SpecialDriverWrite2.class);
    ...
    try (BufferedReader csvReader = new BufferedReader(new FileReader("/home/alee/nike/nike-sort1.csv"))) {
      ...
      while ((row = csvReader.readLine()) != null) {
        ...
        if (count % 100 == 0) {
          ...
          aw.write(transction, "testorg1", "asset_sw_int_small", entities);
          System.out.println("End write took " + (System.currentTimeMillis() - mark) / 1000 + " seconds");
          long mark2 = System.currentTimeMillis();
          aw.save(transction, "testorg1", "asset_sw_int_small");
          entities.clear();
